...
apt-get install -y openbox obconf obmenu xinit lxappearance compton xfce4-screenshooter xfce4-clipman xfce4-power-manager arandr htop libexo-1-0 gsimplecal
...
cp -r "$base_dir/openbox_menu" /usr/share/icons/
